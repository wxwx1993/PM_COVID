...
glmm.zinb.off = glmm.zinb(fixed = Deaths ~ mean_pm25 +scale(poverty) + scale(popdensity)  +scale(medianhousevalue) 
                          ...
                          +scale(education)  +scale(pct_blk) + scale(older_pecent) #+ scale(totalTestResults)
...
glmm.zinb.off = glmm.zinb(fixed = Deaths ~ mean_pm25 +scale(poverty) + scale(popdensity)  +scale(medianhousevalue) 
                          +scale(medhouseholdincome) + scale(pct_owner_occ)  +scale(hispanic) 
                          +scale(education)  +scale(pct_blk) + scale(older_pecent) + scale(beds)
                          + offset(log(population)), 
                          random = ~ 1 | state, data = (aggregate_pm_census_cdc_test_beds)) 
summary(glmm.zinb.off)
fixed(glmm.zinb.off)$dist[2,1]
...
glmm.zinb.off = glmm.zinb(fixed = Deaths ~ mean_pm25 +scale(poverty) + scale(popdensity)  +scale(medianhousevalue) 
                          +scale(medhouseholdincome) + scale(pct_owner_occ)  +scale(hispanic) 
                          +scale(education)  +scale(pct_blk) + scale(older_pecent) + scale(smoke_rate) + scale(mean_bmi)
                          + offset(log(population)), 
                          random = ~ 1 | state, data = (aggregate_pm_census_cdc_test_beds)) 
#summary(glmm.zinb.off)
fixed(glmm.zinb.off)$dist[2,1]
...
# + analysis with category popdensity
...
glmm.zinb.log = glmm.zinb(fixed = Deaths ~ mean_pm25 +scale(poverty) + factor(q_popdensity)   +scale(medianhousevalue) 
                          +scale(medhouseholdincome) + scale(pct_owner_occ)  +scale(hispanic) 
                          +scale(education)  +scale(pct_blk) + scale(older_pecent)
                          + scale(log(population)), 
                          random = ~ 1 | state, data = (aggregate_pm_census_cdc_test_beds)) 
...
glmm.zinb.nonlog = glmm.zinb(fixed = Deaths ~ mean_pm25 +scale(poverty) + factor(q_popdensity)   +scale(medianhousevalue) 
                             +scale(medhouseholdincome) + scale(pct_owner_occ)  +scale(hispanic) 
                             +scale(education)  +scale(pct_blk) + scale(older_pecent)
                             + scale((population)), 
                             random = ~ 1 | state, data = (aggregate_pm_census_cdc_test_beds)) 
...
mode.nb.random.log = glmer.nb(Deaths ~ mean_pm25 + scale(poverty) +scale(medianhousevalue) + scale(popdensity)
                              +scale(medhouseholdincome) + scale(pct_owner_occ)  +scale(hispanic)  
                              +scale(education) + scale(pct_blk) + scale(older_pecent) + (1|state)
                              + scale(log(population)), data = aggregate_pm_census_cdc_test_beds)
summary(mode.nb.random.log)

mode.nb.random = glmer.nb(Deaths ~ mean_pm25 + scale(poverty) +scale(medianhousevalue) + scale(popdensity)
                          +scale(medhouseholdincome) + scale(pct_owner_occ)  +scale(hispanic)  
                          +scale(education) + scale(pct_blk) + scale(older_pecent) + (1|state)
                          + scale((population)), data = aggregate_pm_census_cdc_test_beds)
summary(mode.nb.random)
